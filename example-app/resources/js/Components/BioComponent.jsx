...
export default function BioComponent(props) {
 ...
 let  Follow = ( props.info.follower.find(oggetto => oggetto.user.id === props.info.auth.user.id))
  ...
  const handleSubmit = (e) => {
    ...
    router.post('/follower', { auth: props.info.auth.user.id , 
                           user: props.info.user.id }, { preserveScroll: true })
  ...
  return (
    ...
    <div className="section-box" id="about ">
      <div className="row g-4 g-xl-5">
        <div className="col-12 col-xl-4">
          <div className="hero-avatar">
            ...
            <div className="hero-avatar-text">
              <span className="typer" id="typer1" data-words="Hi There!, I'm Christina" data-delay="50" data-deletedelay="1500" style={{ color: 'black' }}> I'm {info.name}</span><span className="cursor" data-owner="typer1" style={{ transition: 'all 0.1s ease 0s', opacity: 1 }}>_</span>
            </div>
          </div>
        </div>
        ...
        {props.info.auth.user.id !== props.info.user.id ?  <button onClick={handleSubmit} className="btn btn-primary mt-3">
          
          
    {Follow ? "Unfollow" : "Follow"}
          </button> : <button className="btn btn-primary mt-3">Modifica Profilo</button>}

         

          <ul className="list-inline-pills mt-3">
            <li><i className="fa-brands fa-html5 pe-2"></i> #TREND 1
             
            </li>
            <li><i className="fa-brands fa-bootstrap pe-2"></i> #TREND 2
             
            </li>
            <li><i className="fa-solid fa-magnifying-glass pe-2"></i>#TREND 3
